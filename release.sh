...
sed -E -i.bak -e 's/\[([0-9]+\.[0-9]+\.[0-9]+)\.Final\]/[\1]/g' -e 's/v([0-9]+\.[0-9]+\.[0-9]+)\.Final/v\1/g' CHANGELOG.md && rm CHANGELOG.md.bak
msg "Push changes"
...
msg ""
msg "Check the validation after ${YELLOW}10 minutes${NOFORMAT} on ${CYAN}https://repository.jboss.org/nexus${NOFORMAT}."
