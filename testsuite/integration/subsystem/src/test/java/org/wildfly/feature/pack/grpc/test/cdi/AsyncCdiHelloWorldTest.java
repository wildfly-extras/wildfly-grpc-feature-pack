...
/**
 * Tests that an {@code @ApplicationScoped} gRPC service implementing
 * {@link GreeterGrpc.AsyncService} can use CDI injection.
 */
...
public class AsyncCdiHelloWorldTest {
    ...
    public static Archive<?> createTestArchive() {
        WebArchive war = ShrinkWrap.create(WebArchive.class, "AsyncCdiHelloWorldTest.war");
        war.addClasses(AsyncCdiHelloWorldTest.class, AsyncGreeterServiceImpl.class, GreetingService.class);
