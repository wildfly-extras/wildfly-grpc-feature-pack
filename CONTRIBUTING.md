First off, thank you for considering contributing to WildFly gRPC. WildFly gRPC is an open source project, and we love to receive contributions from our community — you! There are many ways to contribute, from writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or writing code which can be incorporated into WildFly gRPC itself.
...
Fork https://github.com/wildfly-extras/wildfly-grpc-feature-pack into your GitHub account.

## Clone your newly forked repository onto your local machine

```bash
git clone git@github.com:[your username]/wildfly-grpc-feature-pack.git
...
```bash
git remote add upstream git://github.com/wildfly-extras/wildfly-grpc-feature-pack.git
```

# Development Process

This is the typical process you would follow to submit any changes to WildFly gRPC.
 ...
 * Issue Tracker - https://github.com/wildfly-extras/wildfly-grpc-feature-pack/issues
 * Chat - https://wildfly.zulipchat.com
